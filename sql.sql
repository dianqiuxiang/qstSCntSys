...
CREATE TABLE `customerinfo` (
  ...
  `isDelete` int(11) DEFAULT NULL COMMENT '是否删除：0 没删除，1 删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='顾客信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customerinfo` VALUES (1,'12332112332','aa','十二号',3,0);
...
CREATE TABLE `everymonthotherinfo` (
  ...
  `isDelete` int(11) DEFAULT NULL COMMENT '是否删除：0 没删除，1 删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='月报其他信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `expenseitem` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='费用项目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `receiptinfo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='收款信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `salesdepartmentinfo` (
  ...
  `isDelete` int(11) DEFAULT NULL COMMENT '是否删除：0 没删除，1 删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='销售部信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salesdepartmentinfo` VALUES (1,'虎踞总部','虎踞路','12332112332',0,1,0),(2,'虎踞路-浦口市场','浦口','12332112332',1,2,0),(3,'殷李桂+李荣华销售部','浦口','12332112332',2,3,0),(4,'镇江市场','镇江','11111111111',1,2,0),(5,'京口销售部','镇江京口','22222222222',4,3,0);
...
INSERT INTO `userinfo` VALUES (1,'123','123','12332112332','123456@qq.com',3,0);
...
-- Dump completed on 2018-04-09 16:09:07
